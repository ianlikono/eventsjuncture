 ...
 font-size:${props=>props.theme.fontSize};
  ...
  ${props =>
    ...
    css`
      ...
      &:hover {
        background-image: ${props =>
          `linear-gradient(to left,${props.theme.colorPurpleLight},${
            props.theme.colorPurpleDark
          }`};
      }
    `};
  ...
  ${props =>
    ...
    css`
      background-image: ${props =>
        `linear-gradient(to bottom right,${props.theme.colorAquaDark},${
          props.theme.colorAquaMild
        },${props.theme.colorAquaLight},${props.theme.colorAquaVeryLight})`};
      &:hover {
        background-image: ${props =>
          `linear-gradient(to left,${props.theme.colorAquaDark},${
            props.theme.colorAquaMild
          },${props.theme.colorAquaLight})`};
      }
    `};
